              ...
              >
                <div className="relative h-[550px] w-full rounded-2xl overflow-hidden group cursor-pointer border border-[#FAF7F2]/10 bg-[#0A1A14]">
                  ...
                  <div className="absolute inset-0">
                    <div className="absolute inset-0 bg-primary/40 mix-blend-multiply z-10 transition-opacity duration-700 group-hover:opacity-60" />
                    <img 
                      src={prog.image} 
                      className="absolute inset-0 w-full h-full object-cover transition-transform duration-[1.5s] group-hover:scale-110 filter brightness-75" 
                      alt={prog.title}
                    />
                  </div>
                  ...
                  <div className="absolute bottom-6 left-6 right-6 z-20 translate-y-12 group-hover:translate-y-0 transition-transform duration-500 ease-out">
                    <h3 className="font-serif text-3xl text-white mb-3 group-hover:text-gold transition-colors duration-300">
                      {prog.title}
                    </h3>
                    ...
                    <div className="w-full h-[1px] bg-white/10 mb-5 relative overflow-hidden group-hover:bg-gold/30 transition-colors duration-500">
                      <div className="absolute top-0 left-0 bottom-0 w-0 bg-gold group-hover:w-full transition-all duration-[1s] ease-out delay-200" />
                    </div>
